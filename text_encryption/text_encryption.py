...
def main_screen():
    ...
    Label(text ="Enter Key for encryption and decryption",fg="black",font=("calbri",13)).place(x=10,y=170)

    code=StringVar()
    Entry(textvariable=code,width=38,bd=0,font=("arial,35"),show="*").place(x=10,y=200)
